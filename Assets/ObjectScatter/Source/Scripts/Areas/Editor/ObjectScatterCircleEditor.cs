...
{
    [CustomEditor(typeof(ObjectScatterCircle))]
    public class ObjectScatterCircleEditor : ObjectScatterPathEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            creator = (ObjectScatterCircle)target;
            ...
            GatherProperties(typeof(ObjectScatterCircle));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                Undo.RecordObject(creator, "Reset Circle");
