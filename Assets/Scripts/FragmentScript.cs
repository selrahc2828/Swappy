...
public class FragmentScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine(LifeTimer());// desactive collider et met rb en kinematic quand rb est sleep et pas dans range de ramassage du joueur
    }
    ...
    void FixedUpdate()
    {
        if (followWaittingAllow && target)
        {
            ...
            _rb.AddForce(direction * force); // faire un mode pour ignorer la masse
        }
    }
