...
public class ControllerGreg : MonoBehaviour
{
    public static Controls controls;
    public Camera mainCamera;
    public ComponentStealerOld stealPasteSript;
    ...
    void Start()
    {
        ...
        controls.Player.ResetListComportement.performed += ResetListComportement;
...
private void OnDisable()
    ...
    private void ResetListComportement(InputAction.CallbackContext context)
    {
        if (context.performed)
        {
            // if bool == true set false et vice versa

            stealPasteSript.ResetList();
        }
    }
